...
#+BEGIN_SRC emacs-lisp
  ...
  (setq org-agenda-sorting-strategy '((agenda habit-down time-up deadline-up priority-down effort-down category-keep)
...
** Midnight Mode
#+begin_src emacs-lisp 
  (defun sync-org-with-dropbox ()
    (interactive)
    (let ((org-dir-path "~/org/")
	  (dropbox-dir-path "~/Dropbox (Amherst College)/")
	  (dropbox-org-dir-path "~/Dropbox (Amherst College)/org/"))
      (delete-directory dropbox-org-dir-path t)
      (copy-directory org-dir-path dropbox-dir-path)))

...
#+begin_src emacs-lisp
  ...
  (setq org-global-properties '(("Effort_ALL" . "0 0:05 0:10 0:15 0:30 1:00 2:00 3:00 4:00")))
...
*** Agenda 
#+BEGIN_SRC emacs-lisp
  (setq org-agenda-files '("~/git/meta/main.org"))
...
#+begin_src emacs-lisp 
  (setq org-capture-templates '(("i" "inbox")
				("l" "log")
				("ie" "Emacs Inbox" checkitem (file+olp "~/git/meta/main.org" "Emacs Personalization" "Inbox") "")
				("le" "Emacs Log" entry (file+olp "~/git/meta/main.org" "Emacs Personalization" "Log") "*** %U ")
				("im" "Meta Inbox" checkitem (file+olp "~/git/meta/main.org" "Meta Management" "Inbox") "")
				("lm" "Meta Log" entry (file+olp "~/git/meta/main.org" "Meta Management" "Log") "*** %U")
				("it" "Thesis Inbox" checkitem (file+olp "~/git/meta/main.org" "Computer Science Thesis" "Inbox") "")
				("lt" "Thesis Log" entry (file+olp "~/git/meta/main.org" "Computer Science Thesis" "Log") "*** %U ")))
#+end_src
** Magit
